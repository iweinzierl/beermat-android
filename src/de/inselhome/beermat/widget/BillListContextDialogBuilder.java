...
public class BillListContextDialogBuilder {
    ...
    public static Dialog build(Context context, Callback callback) {
        BillListContextDialogBuilder.callback = callback;
        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = layoutInflater.inflate(R.layout.dialog_billcontext, null, true);
